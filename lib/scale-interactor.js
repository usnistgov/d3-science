...
})(this, function (exports, _jqueryExtend) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = exports.scaleInteractor = undefined;
  exports.scaleInteractor = scaleInteractor;
  exports.default = scaleInteractor;
    ...
    function interactor(selection) {
      ...
      selection.selectAll("g.series").each(function (d, i) {
        ...
        var drag_point = d3.drag().on("drag", dragmove_point).on("start", function () {
          d3.event.sourceEvent.stopPropagation();dispatch.call("start");
        }).on("end", function () {
          dispatch.call("end");
        });
