(function (global, factory) {
...
})(this, function (exports, _jqueryExtend, _generateId, _colormap) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = exports.heatChartMultiMasked = undefined;

  var lib_colormap = _interopRequireWildcard(_colormap);
  ...
  exports.heatChartMultiMasked = heatChartMultiMasked;
  exports.default = heatChartMultiMasked;
      ...
      if (options.position_cursor) {
        ...
        function get_z(data, dims, x_coord, y_coord) {
          ...
          if (x_rel >= 1.0 || x_rel < 0 || y_rel >= 1.0 || y_rel < 0) {
            ...
            var y_bin = Math.floor(y_rel * dims.ydim);
