(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'd3', './jquery-extend', './generate-id', './colormap'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('d3'), require('./jquery-extend'), require('./generate-id'), require('./colormap'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.d3, global.jqueryExtend, global.generateId, global.colormap);
    global.heatChartMultiMasked = mod.exports;
  }
})(this, function (exports, _d, _jqueryExtend, _generateId, _colormap) {
  "use strict";
