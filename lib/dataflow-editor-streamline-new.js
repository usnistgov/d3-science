    ...
    return function (data) {
      ...
      */
      ...
      function update() {
        ...
        rewire(index_updates); // remove wires without existing endpoints;
      ...
      function editor(selection) {
        ...
        svg = selection.selectAll("svg.editor").data(data).enter().append("svg").classed("editor", true); // unique id will be assigned to module when created...
      ...
      function module(module_data) {
        ...
        var module_name = module_data.module; // lookup first from module_data, then editor instance.
