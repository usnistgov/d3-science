(function (global, factory) {
  ...
  _exports.default = _exports.overlayInteractor = overlayInteractor;
  var debug = false;
  ...
  function overlayInteractor(state, x, y) {
    ...
    return function (x, y) {
      ...
      function interactor(selection) {
        ...
        var foreignObject = group.append("foreignObject"); // add embedded canvas to embedded body

        var canvas = foreignObject.append("xhtml:canvas").attr("xmlns", "http://www.w3.org/1999/xhtml").classed("overlay", true) //.attr("x", 0)
        //.attr("y", 0)
        .style("width", "100%").style("height", "100%") //.attr("width", 100)
        //.attr("height", 200)
