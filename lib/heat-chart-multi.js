(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'd3', './jquery-extend', './generate-id'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('d3'), require('./jquery-extend'), require('./generate-id'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  function heatChartMulti(options_override) {
    ...
    function drawImages(canvas) {
      ...
      for (var image_index in source_contexts) {
        ...
        var _ctx = source_contexts[image_index];
        context.drawImage(_ctx.canvas, sxdx.sx, sxdx.sy, sxdx.sw, sxdx.sh, sxdx.dx, sxdx.dy, sxdx.dw, sxdx.dh);
      }
    }
