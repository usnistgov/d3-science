(function (global, factory) {
  ...
  _exports.linePolygonIntersects = linePolygonIntersects;
  _exports.lineLineIntersect = lineLineIntersect;
  _exports.reflect = reflect;
  ...
  function lineLineIntersect(line1, line2, calculate_reflection) {
    ...
    var ret = null; // dx1, dy1, etc. are start-end for that line
  ...
  function reflect(dx1, dy1, dx2, dy2) {
    ...
    var reflected = {
      x: (parallel_x - perp_x) / denom2,
      y: (parallel_y - perp_y) / denom2
    };
    return reflected;
  }
});
