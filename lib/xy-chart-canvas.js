(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './jquery-extend.js', './generate-id.js', 'jsdom'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./jquery-extend.js'), require('./generate-id.js'), require('jsdom'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.jqueryExtend, global.generateId, global.jsdom);
    global.xyChartCanvas = mod.exports;
  }
})(this, function (exports, _jqueryExtend, _generateId, _jsdom) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = exports.xyChart = undefined;
  ...
  function xyChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        mainview.append("rect").classed("zoom-box", true).attr("width", width).attr("height", height).style("visibility", "hidden").attr("pointer-events", "all").on("dblclick.zoom", null)
        //.on("dblclick.resetzoom", null)
        ...
        if (options.position_cursor) {
          ...
          mainview.on("mousemove.position_cursor", follow);
      ...
      series_sel.each(function (s, i) {
        ...
        s.forEach(function (d, i) {
          ...
          if (draw_top_bottom) {
            ...
            ctx.lineTo(px + errorbar_width / 2.0, puy);
            // draw the vertical...
            ctx.moveTo(px, puy);
            ctx.lineTo(px, ply);
            // draw the bottom bar
          ...
          if (draw_left_right) {
            ...
            ctx.lineTo(plx, py + errorbar_width / 2.0);
            // draw the horizontal...
            ctx.moveTo(plx, py);
            ctx.lineTo(pux, py);
            // draw the right bar
