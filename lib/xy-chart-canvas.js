  ...
  function xyChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var canvas_container = outercontainer.append("div").attr("class", "canvas-container").style("position", "absolute").style("left", options.margin.left + "px").style("top", options.margin.top + "px");
        //************************************************************
