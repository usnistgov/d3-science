(function (global, factory) {
  ...
  _exports.default = _exports.polygonInteractor = polygonInteractor;
  ...
  function polygonInteractor(state, x, y) {
    ...
    return function (x, y) {
      ...
      function interactor(selection) {
        ...
        var edge_group = group.append("g").attr("class", "edges").style("stroke", state.color1).style("stroke-linecap", "round").style("stroke-width", "4px").style("fill", state.fill || "none"); //if (!fixed) edges.call(drag_edge);
