(function (global, factory) {
  ...
  function xyChart(options_override) {
    ...
    chart.draw_points = function (data) {
      ...
      update_sel.enter().append("circle") //.filter(function(d) { return (d && d[1] != null && isFinite(x(d[0])) && isFinite(y(d[1]))); })
    ...
    function errorbar_generator(d) {
      ...
      var draw_top_bottom = d[2].yupper != d[2].ylower && isFinite(x(d[0])) && isFinite(y(d[2].ylower)) && isFinite(y(d[2].yupper));
      var draw_left_right = d[2].xupper != d[2].xlower && isFinite(y(d[1])) && isFinite(x(d[2].xlower)) && isFinite(x(d[2].xupper));
      var px = x(d[0]),
          py = y(d[1]),
          pux = x(d[2].xupper),
          plx = x(d[2].xlower),
      ...
      if (draw_top_bottom) {
        ...
        pathstring += "," + puy.toFixed(3); // draw the vertical...

        pathstring += "M" + px.toFixed(3);
        pathstring += "," + puy.toFixed(3);
        pathstring += "L" + px.toFixed(3);
        pathstring += "," + ply.toFixed(3); // draw the bottom bar
      ...
      if (draw_left_right) {
        ...
        pathstring += "," + (py + errorbar_width / 2.0).toFixed(3); // draw the horizontal...

        pathstring += "M" + plx.toFixed(3);
        pathstring += "," + py.toFixed(3);
        pathstring += "L" + pux.toFixed(3);
        pathstring += "," + py.toFixed(3); // draw the right bar
