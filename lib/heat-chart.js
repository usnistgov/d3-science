  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        if (container.empty()) {
          container = outercontainer.append("div").attr("class", "heatmap-container").attr("width", innerwidth).attr("height", innerheight)
          //.style("left", "0")
          //.style("top", "0")
    ...
    chart.colorbar = function (selection) {
      selection.each(function (data) {
        ...
        if (container.empty()) {
          container = outercontainer.append("div").attr("class", "colorbar-container").attr("width", innerwidth).attr("height", innerheight).style("display", "inline-block").style("width", innerwidth + "px").style("height", innerheight + "px");

          colorbarCanvas = container.append("canvas");
          colorbarCanvas.attr("width", width).attr("height", height).attr("class", "colorbar").style("width", width + "px").style("height", height + "px").style("padding-left", offset_left + "px").style("padding-right", options.cb_margin.right + "px").style("padding-top", options.cb_margin.top + "px");
        } else {
