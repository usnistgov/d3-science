(function (global, factory) {
  ...
  _exports.default = _exports.rectangleInteractor = rectangleInteractor;
  ...
  function rectangleInteractor(state, x, y) {
    ...
    return function (x, y) {
      ...
      function dragmove_corner() {
        var grid_spacing = state.grid_spacing;
        ...
        var vertex = parseInt(d3.select(this).attr("vertex")); // enforce relationship between corners:
      ...
      function dragmove_edge() {
        ...
        var side = parseInt(d3.select(this).attr("side")); // enforce relationship between edges and corners:
